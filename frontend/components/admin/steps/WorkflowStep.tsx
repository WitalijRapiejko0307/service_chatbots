...
export function WorkflowStep({ config, errors, onUpdate }: WorkflowStepProps) {
  ...
  return (
    <div className="flex flex-col h-full space-y-4">
      {/* Master toggle */}
      <div className="flex items-start justify-between gap-4 p-4 border border-border rounded-lg bg-surface-hover flex-shrink-0">
        <div className="min-w-0">
          <p className="font-medium text-foreground">Сценарный Workflow</p>
