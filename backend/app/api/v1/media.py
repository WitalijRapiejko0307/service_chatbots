"""Media upload endpoint — stores chat attachments in local storage."""
...
async def upload_chat_media(
    ...
    """Upload a chat media file (image / video / audio / document) to local storage.

    Returns the public local storage URL that can be included in admin messages
