...
class RestrictionsConfig(BaseModel):
    """Content and scope restrictions for service-business agents."""

    no_diagnosis: bool = Field(default=False)
    no_treatment_recommendations: bool = Field(default=False)
    no_drug_advice: bool = Field(default=False)
    no_test_interpretation: bool = Field(default=False)
    no_pre_procedure_recommendations: bool = Field(default=False)
    no_slot_selection: bool = Field(default=False)
    no_repeat_patients: bool = Field(default=False)
...
class HandoffConfig(BaseModel):
    ...
    default_handoff_target: str = Field(default="operator")
...
class EscalationConfig(BaseModel):
    ...
    medical_question_policy: str = Field(
        default="handoff_or_answer_from_rag",
        description="Free text policy for informational questions (FAQ / knowledge base).",
    )
